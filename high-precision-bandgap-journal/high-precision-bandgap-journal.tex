...
\begin{abstract}
    Includes specifications for the block. Different topologies. 

    \textbf{Keywords:} high precision, trimming, Kuijk, Brokaw, Tsividis, bandgap, voltage reference
\end{abstract}
...
\begin{equation}
    \dfrac{\Delta V_{BE}}{R_3} = \dfrac{V_{BGR} - V_{BE1}}{R_2} = \frac{1}{R}\dfrac{kT}{q} ln (\dfrac{n I_{D1}}{I_{D2}})
\end{equation}
...
\begin{itemize}
    \item input DC opAmp offset
    \item $V_{BE}$ diode connected
\end{itemize}

\newpage % Like and Appendix
